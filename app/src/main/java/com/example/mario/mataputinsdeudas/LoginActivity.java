        ...
        if (Listener == null)
            Listener = new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (keyAnna != null && keyBlanca != null && keyLaurita != null && keyMario != null && keyLauron != null) {
    ...
    public void SaveLog(String log, String message) {
        ...
        if (myRef != null) {
            try {
                ...
                myRef.child("LOG").child(hora.format(Calendar.getInstance().getTime())).child("Titulo").setValue(log + " " + "Login");
            }
